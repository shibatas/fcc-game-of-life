...
const Footer = () => {
	return (
		<footer style={{textAlign:'center'}}>
			<hr style={{width: '90%'}}/>
		        <p>This is a <a href="https://www.freecodecamp.org/challenges/build-the-game-of-life" target="_blank" rel="noopener noreferrer">freeCodeCamp project</a>. The code can be found <a href="https://github.com/shibatas/fcc-game-of-life" target="_blank" rel="noopener noreferrer">here</a>.</p>
